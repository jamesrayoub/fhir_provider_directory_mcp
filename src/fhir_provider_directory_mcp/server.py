...
async def search_practitioner(
    identifier: Annotated[
        Optional[str], Field(description="The identifier of the practitioner; i.e. NPI")
    ] = None,
    family: Annotated[
        Optional[str], Field(description="The family name (surname)")
    ] = None,
    given: Annotated[
        Optional[str], Field(description="The given name (first name)")
    ] = None,
    address_state: Annotated[
        Optional[str], Field(description="The state of the practitioner's address")
    ] = None,
    limit: Annotated[
        Optional[int], Field(description="Number of results to return", ge=1, le=1000)
    ] = 25,
) -> str:
    """
...
async def search_practitioner_role(
    practitioner: Annotated[
        Optional[str],
        Field(
            description='reference to the practitioner (e.g. "Practitioner/123" or just "123")'
        ),
    ] = None,
    organization: Annotated[
        Optional[str], Field(description="reference to the organization")
    ] = None,
    location: Annotated[
        Optional[str], Field(description="reference to the location")
    ] = None,
...
async def search_location(
    name: Annotated[
        Optional[str], Field(description="A portion of the location's name or alias")
    ] = None,
    address: Annotated[
        Optional[str], Field(description="A portion of the address parts")
    ] = None,
    city: Annotated[
        Optional[str], Field(description="The city specified in an address")
    ] = None,
    state: Annotated[
        Optional[str], Field(description="The state specified in an address")
    ] = None,
    postal_code: Annotated[
        Optional[str], Field(description="A postal code specified in an address")
    ] = None,
    usage: Annotated[Optional[str], Field(description="Location usage code")] = None,
    status: Annotated[
        Optional[str], Field(description="active | suspended | inactive")
    ] = None,
    limit: Annotated[
        Optional[int], Field(description="Number of results to return", ge=1, le=1000)
    ] = 50,
...
async def search_organization(
    name: Annotated[
        Optional[str], Field(description="A portion of the organization's name")
    ] = None,
    type: Annotated[
        Optional[str],
        Field(
            description="A code for the type of organization (e.g., prov | dept | ins | pay)"
        ),
    ] = None,
    partof: Annotated[
        Optional[str], Field(description="Reference to the parent organization")
    ] = None,
    limit: Annotated[
        Optional[int], Field(description="Number of results to return", ge=1, le=1000)
    ] = 25,
...
async def search_organization_affiliation(
    primary_organization: Annotated[
        Optional[str], Field(description="Reference to the primary organization")
    ] = None,
    participating_organization: Annotated[
        Optional[str], Field(description="Reference to the participating organization")
    ] = None,
    role: Annotated[
        Optional[str],
        Field(description="Definition of the role the participatingOrganization plays"),
    ] = None,
    specialty: Annotated[
        Optional[str],
        Field(
    ...
    location: Annotated[
        Optional[str], Field(description="The location(s) at which the role occurs")
    ] = None,
    limit: Annotated[
        Optional[int], Field(description="Number of results to return", ge=1, le=1000)
    ] = 100,
...
async def search_healthcare_service(
    organization: Annotated[
        Optional[str],
        Field(description="The organization that provides this Healthcare Service"),
    ] = None,
    location: Annotated[
        Optional[str],
        Field(description="The location(s) where this Healthcare Service is provided"),
    ] = None,
    name: Annotated[
        Optional[str], Field(description="A portion of the Healthcare Service name")
    ] = None,
    category: Annotated[
        Optional[str], Field(description="Service Category of the Healthcare Service")
    ] = None,
    type: Annotated[
        Optional[str],
        Field(
            description="The Code or Name of the Service Type of the Healthcare Service"
        ),
    ] = None,
    specialty: Annotated[
        Optional[str], Field(description="The specialty of the service provided")
    ] = None,
    limit: Annotated[
        Optional[int], Field(description="Number of results to return", ge=1, le=1000)
    ] = 25,
...
async def search_insurance_plan(
    name: Annotated[
        Optional[str], Field(description="A portion of the insurance plan name")
    ] = None,
    type: Annotated[
        Optional[str],
        Field(description="Kind of plan (e.g. medical | dental | mental)"),
    ] = None,
    administered_by: Annotated[
        Optional[str], Field(description="Product administrator (Organization)")
    ] = None,
    owned_by: Annotated[
        Optional[str], Field(description="Product issuer (Organization)")
    ] = None,
    coverage_area: Annotated[
        Optional[str], Field(description="The coverage area for the product (Location)")
    ] = None,
    limit: Annotated[
        Optional[int], Field(description="Number of results to return", ge=1, le=1000)
    ] = 25,
...
async def read_resource(
    resource_type: Annotated[
        ...
        Field(
            description='The type of resource (e.g., "Practitioner", "Organization", "Location")'
        ),
    ],
    ...
    return json.dumps(resource.serialize())
